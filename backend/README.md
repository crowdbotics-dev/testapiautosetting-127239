...
## Project Structure
    ...
    ├── testapiautosetting_127239  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127239`
...
2. Clone this repo and `cd testapiautosetting_127239`
